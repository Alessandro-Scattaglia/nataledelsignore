  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-col">
        ...
        <ul className="footer-list">
          <li>
            ...
            <a
              href="https://maps.google.com/?q=Via+Boston+37,+Torino"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <p className="footer-note">
          Per orari Messe e segreteria vai alla pagina{" "}
          <a href="/nataledelsignore/orari">Orari</a>.
        </p>
      </div>
      ...
      <div className="footer-col">
          ...
          <li>
            ...
            <div>
              <p className="footer-list-title">
                Oratorio Natale del Signore - APS
              </p>
        ...
        <p className="footer-note">
          Causale consigliata: Offerta, Carita, Attivita oratorio.
        </p>
      </div>
      ...
      <div className="footer-col footer-col-social">
        ...
        <ul className="footer-links-inline">
          ...
          <li>
            <a
              href="http://www.madonnadellerose.it"
              target="_blank"
              rel="noreferrer"
            >
              Madonna delle Rose
          ...
          <li>
            <a
              href="http://www.parrocchie.it/torino/mariamadredellachiesa/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="http://www.madremisericordia.it"
              target="_blank"
              rel="noreferrer"
            >
