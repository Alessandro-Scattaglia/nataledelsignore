  ...
  return (
    <article className="page">
      <header className="page-hero page-hero-home">
        ...
        {/* TODO: sostituire con img/DSC2144.jpg */}
        <ImagePlaceholder label="Foto chiesa" height={260} />
      </header>
      ...
      <section className="grid-two">
        ...
        <article className="info-card accent-secondary">
          ...
          {/* TODO: sostituire con img/canaleWhatsapp.jpg */}
          <ImagePlaceholder label="QR Canale WhatsApp" height={130} />
        </article>
      </section>
      ...
      <section className="content-section">
        ...
        <div className="grid-two">
          <article className="plain-card">
            {/* TODO: sostituire con img/attivita/tornei2025.jpg */}
            <ImagePlaceholder label="Locandina tornei 2025" height={220} />
          </article>
          <article className="plain-card">
            {/* TODO: sostituire con img/attivita/concerto2025.jpg */}
            <ImagePlaceholder label="Locandina concerto 2025" height={220} />
          </article>
          <article className="plain-card">
            {/* TODO: sostituire con img/attivita/biciclettata2025.jpg */}
            <ImagePlaceholder label="Locandina biciclettata 2025" height={220} />
          </article>
          <article className="plain-card">
            {/* TODO: sostituire con img/attivita/2025nonna papera.jpg */}
            <ImagePlaceholder label="Locandina torneo Nonna Papera" height={220} />
          </article>
        </div>
      </section>
