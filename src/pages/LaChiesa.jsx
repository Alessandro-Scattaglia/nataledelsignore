  ...
  return (
    <article className="page">
      <header className="page-hero">
        ...
        <ImagePlaceholder label="Esterno chiesa" height={230} />
      </header>
      ...
      <section className="grid-two">
        <article className="info-card accent-secondary">
          ...
          <ImagePlaceholder label="Altare e Natività" height={160} />
        </article>
        ...
        <article className="info-card accent-light">
          ...
          {/* TODO: sostituire con img/tabernacolo.jpg */}
          <ImagePlaceholder label="Tabernacolo" height={160} />
        </article>
      </section>
