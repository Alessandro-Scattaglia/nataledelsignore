  ...
  return (
    <article className="page">
      <header className="page-hero">
        ...
        {/* TODO: sostituire con img/carita.jpg */}
        <ImagePlaceholder label="Iniziative di carità" height={230} />
      </header>
      ...
      <section className="grid-two">
        <article className="plain-card">
          {/* TODO: sostituire con img/attivita/2025-01-22-solidarietà.jpg */}
          <ImagePlaceholder label="Foto iniziativa solidarietà 2025" height={210} />
        </article>
        <article className="plain-card">
          {/* TODO: sostituire con img/attivita/2024-05-solidarietà.jpg */}
          <ImagePlaceholder label="Foto iniziativa solidarietà 2024" height={210} />
        </article>
      </section>
    </article>
  );
