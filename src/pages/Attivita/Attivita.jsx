...
function Attivita() {
	return (
		<article className="page page-attivita">
			<header className="page-hero">
				...
				<img
					src={`${import.meta.env.BASE_URL}img/attivita/attivita.jpg`}
					alt="Attività parrocchiali"
					className="content-image attivita-hero-image"
				/>
			</header>
