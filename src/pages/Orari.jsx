    ...
    <article className="page">
      <header className="page-hero">
        <div>
          ...
          <p>
            La chiesa è aperta tutti i giorni dalle 8:00 alle 12:00 e dalle 16:00 alle 19:00, tranne il lunedì
            pomeriggio.
          </p>
        </div>
        {/* TODO: sostituire con img/nataledelsignore.jpg */}
        <ImagePlaceholder label="Foto ingresso chiesa" height={230} />
      </header>
      ...
      <section className="content-section">
        <article className="info-card accent-light">
          ...
          <p>
            Per ricordare un defunto in una Messa basta passare in sacrestia qualche minuto prima della
            celebrazione e segnalare il nome al celebrante o all&apos;incaricato presente.
          </p>
