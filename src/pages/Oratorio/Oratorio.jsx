...
function Oratorio() {
	return (
		<article className="page page-oratorio">
			<header className="page-hero">
				...
				<img
					src={`${import.meta.env.BASE_URL}img/oratorionds.jpg`}
					alt="Oratorio Natale del Signore"
					className="content-image oratorio-hero-image"
				/>
			</header>
			...
			<section className="content-section">
				<img
					src={`${import.meta.env.BASE_URL}img/oratorio/2025-10-15.jpg`}
					alt="Locandina Oratorio 2025"
					className="content-image oratorio-locandina-image"
				/>
			</section>
